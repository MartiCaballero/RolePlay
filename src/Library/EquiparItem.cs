...
namespace JuegoDeRoles
{
    ...
    {
        public static void Equipar(IPersonaje personaje, IItems items)
        {
        ...
        private static void EquiparArma (IPersonaje personaje, IItems items)
        {
        ...
        private static void EquiparArmadura (IPersonaje personaje, IItems items)
        {
